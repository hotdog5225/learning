...
cookie_hanlder = urllib.request.HTTPCookieProcessor(cook_jar)
# 根据处理器 生成 opener
opener = urllib.request.build_opener(cookie_hanlder)
...
# 1.参数需要尽心转义 urlencode(), 得到str; 2. post请求的 data要求是bytes: encode()
